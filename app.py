...
INDICATORS: Dict[str, Dict[str, Any]] = {
    ...
    "GDP_PER_CAPITA": {
        "indicator_name_zh": "人均 GDP",
        "indicator_name_en": "GDP per capita, current US$",
        "frequency": ["A"],
        "unit": "current US$",
        "calculation": "level",
        "seasonal_adjustment": "NSA",
        "preferred_source": "World Bank",
        "description": "按现价美元计量的人均国内生产总值。",
    },
    "GNI_PER_CAPITA": {
        "indicator_name_zh": "人均 GNI",
        "indicator_name_en": "GNI per capita, current US$",
        "frequency": ["A"],
        "unit": "current US$",
        "calculation": "level",
        "seasonal_adjustment": "NSA",
        "preferred_source": "World Bank",
        "description": "按现价美元计量的人均国民总收入。",
    },
    "POPULATION": {
        "indicator_name_zh": "总人口",
        "indicator_name_en": "Population, total",
        "frequency": ["A"],
        "unit": "persons",
        "calculation": "level",
        "seasonal_adjustment": "NSA",
        "preferred_source": "World Bank",
        "description": "年末或年度估计总人口。",
    },
    "INFLATION_CPI": {
        "indicator_name_zh": "CPI 通胀率",
        "indicator_name_en": "Inflation, consumer prices, annual %",
        "frequency": ["A"],
        "unit": "%",
        "calculation": "YoY",
        "seasonal_adjustment": "NSA",
        "preferred_source": "World Bank",
        "description": "消费者价格指数年度通胀率。",
    },
    "GDP_DEFLATOR": {
        "indicator_name_zh": "GDP 平减指数增速",
        "indicator_name_en": "Inflation, GDP deflator, annual %",
        "frequency": ["A"],
        "unit": "%",
        "calculation": "YoY",
        "seasonal_adjustment": "NSA",
        "preferred_source": "World Bank",
        "description": "GDP 平减指数年度增速。",
    },
    "FDI_NET_INFLOW": {
        "indicator_name_zh": "外商直接投资净流入",
        "indicator_name_en": "Foreign direct investment, net inflows, current US$",
        "frequency": ["A"],
        "unit": "current US$",
        "calculation": "level",
        "seasonal_adjustment": "NSA",
        "preferred_source": "World Bank",
        "description": "外商直接投资净流入，现价美元。",
    },
    "CURRENT_ACCOUNT_BALANCE": {
        "indicator_name_zh": "经常账户差额",
        "indicator_name_en": "Current account balance, current US$",
        "frequency": ["A"],
        "unit": "current US$",
        "calculation": "level",
        "seasonal_adjustment": "NSA",
        "preferred_source": "World Bank",
        "description": "经常账户收支差额，现价美元。",
    },
    "GROSS_SAVINGS": {
        "indicator_name_zh": "总储蓄率",
        "indicator_name_en": "Gross savings, % of GDP",
        "frequency": ["A"],
        "unit": "% of GDP",
        "calculation": "ratio",
        "seasonal_adjustment": "NSA",
        "preferred_source": "World Bank",
        "description": "总储蓄占 GDP 比重。",
    },
    "CPI_LEVEL": {
    ...
    "LABOR_FORCE": {
        "indicator_name_zh": "劳动力人口",
        "indicator_name_en": "Civilian labor force level",
        "frequency": ["M"],
        "unit": "thousands of persons",
        "calculation": "level",
        "seasonal_adjustment": "SA",
        "preferred_source": "BLS",
        "description": "美国民用劳动力人口，季调。",
        "country_scope": ["US"],
    },
    "AVG_HOURLY_EARNINGS": {
        "indicator_name_zh": "平均小时工资",
        "indicator_name_en": "Average hourly earnings, private nonfarm",
        "frequency": ["M"],
        "unit": "US dollars",
        "calculation": "level",
        "seasonal_adjustment": "SA",
        "preferred_source": "BLS",
        "description": "美国私营非农平均小时工资，季调。",
        "country_scope": ["US"],
    },
    "HICP_YOY": {
...
SOURCE_MAPPINGS: Dict[str, Dict[str, Any]] = {
    ...
    "GDP_PER_CAPITA": {
        ...
        "organization": "World Bank",
        "dataset": "World Development Indicators",
        "source_series_code": "NY.GDP.PCAP.CD",
        "supported_countries": "all",
    },
    "GNI_PER_CAPITA": {
        "source": "World Bank",
        "organization": "World Bank",
        "dataset": "World Development Indicators",
        "source_series_code": "NY.GNP.PCAP.CD",
        "supported_countries": "all",
    },
    "POPULATION": {
        "source": "World Bank",
        "organization": "World Bank",
        "dataset": "World Development Indicators",
        "source_series_code": "SP.POP.TOTL",
        "supported_countries": "all",
    },
    "INFLATION_CPI": {
        "source": "World Bank",
        "organization": "World Bank",
        "dataset": "World Development Indicators",
        "source_series_code": "FP.CPI.TOTL.ZG",
        "supported_countries": "all",
    },
    "GDP_DEFLATOR": {
        "source": "World Bank",
        "organization": "World Bank",
        "dataset": "World Development Indicators",
        "source_series_code": "NY.GDP.DEFL.KD.ZG",
        "supported_countries": "all",
    },
    "FDI_NET_INFLOW": {
        "source": "World Bank",
        "organization": "World Bank",
        "dataset": "World Development Indicators",
        "source_series_code": "BX.KLT.DINV.CD.WD",
        "supported_countries": "all",
    },
    "CURRENT_ACCOUNT_BALANCE": {
        "source": "World Bank",
        "organization": "World Bank",
        "dataset": "World Development Indicators",
        "source_series_code": "BN.CAB.XOKA.CD",
        "supported_countries": "all",
    },
    "GROSS_SAVINGS": {
        "source": "World Bank",
        "organization": "World Bank",
        "dataset": "World Development Indicators",
        "source_series_code": "NY.GNS.ICTR.ZS",
        "supported_countries": "all",
    },
    "CPI_LEVEL": {
        "source": "BLS",
    ...
    "LABOR_FORCE": {
        ...
        "organization": "U.S. Bureau of Labor Statistics",
        "dataset": "Labor Force Statistics",
        "source_series_code": "LNS11000000",
        "supported_countries": ["US"],
    },
    "AVG_HOURLY_EARNINGS": {
        "source": "BLS",
        "organization": "U.S. Bureau of Labor Statistics",
        "dataset": "Current Employment Statistics",
        "source_series_code": "CES0500000003",
        "supported_countries": ["US"],
    },
    "HICP_YOY": {
        "source": "Eurostat",
...
def build_entry_audit_payload() -> Dict[str, Any]:
    checks = [
        ...
        ("错误码说明", "/error-catalog", build_error_catalog),
...
COMPARE_SNAPSHOT_2023: Dict[str, Dict[str, float]] = {
    ...
    "GDP_PER_CAPITA": {
        "US": 81695, "CN": 12614, "DE": 52745, "JP": 33834,
        "GB": 49099, "IN": 2485, "FR": 44460, "EA": 45700,
    },
    "GNI_PER_CAPITA": {
        "US": 80300, "CN": 13400, "DE": 53600, "JP": 39200,
        "GB": 50400, "IN": 2540, "FR": 44900, "EA": 46200,
    },
    "POPULATION": {
        "US": 334914895, "CN": 1410710000, "DE": 84482267, "JP": 124516650,
        "GB": 68350000, "IN": 1428627663, "FR": 68170228, "EA": 350000000,
    },
    "INFLATION_CPI": {
        "US": 4.1, "CN": 0.2, "DE": 5.9, "JP": 3.3,
        "GB": 7.3, "IN": 5.6, "FR": 4.9, "EA": 5.4,
    },
    "GDP_DEFLATOR": {
        "US": 3.6, "CN": -0.5, "DE": 6.6, "JP": 4.0,
        "GB": 6.8, "IN": 1.7, "FR": 5.5, "EA": 5.8,
    },
    "FDI_NET_INFLOW": {
        "US": 348000000000, "CN": 42700000000, "DE": 37000000000,
        "JP": 21000000000, "GB": 14000000000, "IN": 28000000000,
        "FR": 36000000000, "EA": 180000000000,
    },
    "CURRENT_ACCOUNT_BALANCE": {
        "US": -905000000000, "CN": 253000000000, "DE": 282000000000,
        "JP": 149000000000, "GB": -93000000000, "IN": -67000000000,
        "FR": -39000000000, "EA": 310000000000,
    },
    "GROSS_SAVINGS": {
        "US": 18.1, "CN": 44.3, "DE": 29.2, "JP": 28.1,
        "GB": 15.6, "IN": 30.7, "FR": 24.6, "EA": 25.4,
    },
    "IMF_GDP_GROWTH": {
        "US": 2.5, "CN": 5.2, "DE": -0.3, "JP": 1.9,
